                ...
                <div class="py-4 max-w-2xl mx-auto">
                    ...
                    <form method="POST" action="{{ route('events.update', ['event' => $event->id]) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea row="3" id="information" name="information" class="block mt-1 w-full field-sizing-content">{{ $event->information }}</x-textarea>
                        </div>
                        ...
                        <div class="md:flex justify-between items-end">
                            ...
                            <div class="flex space-x-4 justify-around">
                                <input type="radio" name="is_visible" value="1" @if($event->is_visible){ checked } @endif>表示
                                <input type="radio" name="is_visible" value="0" @if(!$event->is_visible){ checked } @endif>非表示
                            </div>
                            <x-button class="ms-4">
                                更新する
                            </x-button>
